...
const Footer = () => {
    ...
    return (
        ...
        <CardContent>
          ...
          <Box fontSize={20}>
            StockWatch is Software that provides  live data of stocks and also past 3 years data. It also contains Charts for better Visulization. It has fundamental data of all companies. 
